...
<section class="minprofilback">
    <article class="personalia-minprofilback">
        <h1>Personalia</h1>
        ...
        ?>
        <a href="redigerpersonaliaback.php"><button>Rediger personalia</button></a>
    </article>

    <article class="profiltekst-minprofilback">
        <h1>Profiltekst</h1>
        <br>
        <p><?php if (isset($_SESSION['profiltekst'] )){echo $_SESSION['profiltekst'];} else {echo "Har ikke lagt inn profiltekst enda!";}?>
            </p>
        <a href="redigerprofiltekstback.php"><button>Rediger profiltekst</button></a>
    </article>
    
    <article class="profilbilde-minprofilback">
        <h1>Profilbilde</h1>
        <br><br>
        ...
        <br><br>
        <a href="redigerprofilbildeback.php"><button>Rediger profilbilde</button></a>
    </article>

    <article class="interesser-minprofilback">
        <h1>Interesser</h1>
        <?php if ($resultat) { ?>
            <ul>
        ...
        ?>
        <a href="redigerinteresseback.php"><button>Rediger interesser</button></a>
    </article>
</section>
