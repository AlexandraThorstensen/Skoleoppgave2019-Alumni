...
try {
    ...
    if (isset($_POST['sendmelding'])) {
        ...
        $stmt->execute();
        header("Location: profilback.php?brukernavn=".$brukernavn);
    }
...
<ul class="brodsmuler">
    ...
    <li><a href="profilback.php?brukernavn=<?= $brukernavn;?>"><?php echo $brukernavn;?>'s profil</a></li>
...
<a href="profilback.php?brukernavn=<?= $brukernavn;?>"><button>Tilbake til <?php echo $brukernavn;?> sin profil</button></a>
