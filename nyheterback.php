<?php
// Denne siden er utviklet av Alexandra Thorstensen, siste gang endret 05.06.2019
...
<section class="nyhetermeny">
    <article class="nyheterknappene">
        <a href="opprettnyhetback.php"><button>Opprett nyhet</button></a>
    </article>
</section>
